            ...
            <Card className="bg-gradient-to-br from-[#0f5d47]/95 to-[#0a4535]/95 border-amber-400/30 shadow-xl">
              ...
              <CardContent className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-500/30 to-pink-500/30 hover:from-purple-500/40 hover:to-pink-500/40 text-amber-100 border border-purple-400/40 rounded-xl h-12 justify-start gap-2"
                >
            ...
            <Card className="bg-gradient-to-br from-[#0f5d47]/95 to-[#0a4535]/95 border-amber-400/30 shadow-xl">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-white/10 rounded-xl">
                  ...
                  <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/40">v1.2.0</Badge>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/10 rounded-xl">
